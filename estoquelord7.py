...
#pedir ao gpt fazer um script em python com seleinium que liste o preço e nome dos produtros 
#verceu
import cv2
            ...
            if estoque[nome]["quantidade"] <= 6:
                ...
                if opcao.lower() == "s":
                    for i, contato in enumerate(contatos):
                        print(f"{i+1}. {contato['nome']} da empresa {contato['empresa']}. Telefone: {contato['telefone']}")
                    escolha = int(input("Digite o número do distribuidor que deseja usar: "))
                    distribuidor = contatos[escolha-1]
                    print(f"Você escolheu o distribuidor {distribuidor['nome']} da empresa {distribuidor['empresa']}.")
    ...
    while True:
        ...
        for obj in decoded_objects:
            ...
            if nome in estoque:
                ...
                opcao = input("Deseja remover o produto digitalmente ou manualmente? (d/m) ")
                if opcao.lower() == "d":
                    del estoque[nome]
